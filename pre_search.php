...
for ($i = 0; $i < ( count( $room ) ) ; $i++ ) {
	...
	echo "<tr class=\"dgray\">";
    //施設情報
    echo "<th rowspan=\"3\"><span class=\"f150\">".$rmnm."</span><br>[定員]".$teiin."<a href=\"http://www.kobe-ipc.or.jp/conferenceroom_hall/halls.html#show_space\"class=\"btn btn-primary btn-xs\" role=\"button\">施設情報</a></th>";
